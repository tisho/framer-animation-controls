...
exports.Animation = (function(_super) {
  ...
  Animation.prototype._filterAnimatableProperties = function(properties) {
    ...
    for (k in properties) {
      v = properties[k];
      if (_.isNumber(v) || _.isFunction(v)) {
...
var BaseClass, Defaults, Events, LayerStatesIgnoredKeys, Utils, _,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
  __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
...
exports.LayerStates = (function(_super) {
  ...
  LayerStates.prototype["switch"] = function(stateName, animationOptions, instant) {
    ...
    for (propertyName in _ref) {
      ...
      value = Utils.functor(value).call(this.layer, this.layer, stateName);
    ...
    if (instant === true) {
      ...
      animationOptions = Utils.functor(animationOptions).call(this.layer, this.layer, stateName);
...
},{"./BaseClass":8,"./Defaults":12,"./Events":14,"./Underscore":22,"./Utils":23}],21:[function(require,module,exports){
